...
class HomePage extends GetView<HomeController> {
  ...
  void showSearchDialog() {
    ...
    // 加载搜索历史
    var searchHistory = LocalStorageService.instance.getSearchHistory().obs;
    var showHistory = true.obs;
    
    // 监听输入框变化
    textController.addListener(() {
      showHistory.value = textController.text.isEmpty;
    });
    ...
    void performSearch(String keyword) {
      ...
      // 添加到历史
      LocalStorageService.instance.addSearchHistory(keyword);
      
      Get.back();
      if (mode.value == 0) {
        controller.toSearchRoom(keyword);
      } else {
        controller.toSearchAnchor(keyword);
      }
    }
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            // 搜索历史
            Obx(
              () => showHistory.value && searchHistory.isNotEmpty
                  ? Container(
